 ...
 * 
 * 
 * A empresa que você trabalha descobriu que você está indo muito bem neste curso de Java e pediu para que você desenvolvesse um 
 * programa que calcula os pagamentos para os prestadores de serviços da empresa.
...
Use a formatação de saída com printf para imprimir na saída e o tipo Scanner
 para receber a entrada de dados do usuário.
